...
class MapView extends Component {
  ...
  render() {
    ...
    return(
      <>
        <h1>Elige tu ruta!</h1>
        <LocationSearchInput setCoordsOrigin= {this.setCoordsOrigin} setCoordsDestination= {this.setCoordsDestination}/>
        <p>Las coordenadas son: Latitude: {this.state.destination.lat}  Longitude: {this.state.destination.lng}</p>
